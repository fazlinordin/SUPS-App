...
# --- 1. SETTING AWAL ---
st.set_page_config(page_title="SUPS HJEM V8.9", layout="wide")
...
# --- 2. MASTER LIST UBAT LENGKAP (Termasuk Fusidic Acid 2% Ointment) ---
MASTER_UBAT = sorted([
    ...
    "Fusidic Acid 2% Ointment", "Fusidic Acid 1% Eye Drops", "Fusidic Acid 2% in Betamethasone Valerate 0.1% Cream", 
    "Gabapentin 300 mg Capsule", "Gabapentin 600 mg Tablet", "Gamma Benzene Hexachloride 0.1 % Lotion", 
    "Gamma Benzene Hexachloride 1% Lotion", "Gemfibrozil 300 mg Capsule", "Glibenclamide 5 mg Tablet", 
    "Gliclazide 30 mg MODIFIED RELEASE Tablet", "Gliclazide 60 mg MODIFIED RELEASE Tablet", "Gliclazide 80 mg Tablet", 
    "Glycerin (Liquid)", "Glycerine 25% in Aqueous Cream", "Glycerin 25%, Sodium Chloride 15% Enema (Ravin)", 
    "Glyceryl Trinitrate 0.5 mg Tablet", "Glycopyrronium 50mcg Inhalation Powder Hard Capsules", "Griseofulvin 125mg Tablet", 
    "Haloperidol 1.5 mg Tablet", "Haloperidol 5mg Tablet", "Hepatitis B 10mcg HbsAg Vaccine (Pediatric)", "Hepatitis B 20mcg HbsAg Vaccine (Adult)", 
